...
class RJ(Ppe):
    ...
    def confere_cnj(self, numero_busca):
        ...
        n = self.driver.find_element_by_xpath('//*[@id="pdf"]/div/div[2]/div[2]/div[1]/div')
        # if not n:
        #     raise MildException("Captcha Solicitado", self.uf, self.plataforma, self.prc_id)
    ...
    def ultima_movimentacao(self,ultima_data, prc_id, base):
        ...
        dia = ultima_mov.find_element_by_xpath('div[2]/div[1]/label[2]').text
        ...
        return Acompanhamento.compara_mov(base, prc_id, tipo.strip(), acp_cadastro, self.plataforma, self.grau, campo = 'acp_esp',
                                          rec_id=self.rec_id)
