...
class Ppe(PrimeiroGrau):
    ...
    def ultima_movimentacao(self,ultima_data, prc_id, base):
        ...
        return Acompanhamento.compara_mov(base, prc_id, acp_esp, data_cad, self.plataforma, self.grau)
    ...
    def acompanhamentos(self, proc_data, completo, base):
            ...
            for al in alerts:
                ...
                if txt.find('MIGRADO') > -1:
                    ...
                    if not Processo.processo_existe(base, cnj):
                        ...
                        np = [{'prc_numero': cnj, 'prc_estado': self.uf, 'prc_autor': proc_data['prc_autor'], 'prc_pai': prc_id, 'prc_area': 1, 'prc_carteira': proc_data['prc_carteira']},]
        ...
        d1 = self.driver.find_element_by_xpath('//*[@id="container-principal"]/ppe-detalhes-processo/div[' + str(di) + ']/ppe-collapsible/div[2]/ppe-detalhes-processo-movimentos-documentos/div[2]/p-datatable/div/div[1]/div/div[2]/div/table/tbody/tr').text.strip()
        inicio = time.time()
        while d1 == '':
    ...
    def responsaveis(self):
        ...
        href = 'https://consulta.tjrs.jus.br/consulta-processual/processo/partes?codComarca=' + comarca + '&numeroProcesso=' + numero + '&perfil=0'
        ...
        self.driver.get('https://consulta.tjrs.jus.br/consulta-processual/processo/informacoes/outras-informacoes?codComarca=' + comarca + '&numeroProcesso=' + numero)
        ...
        for mov in movimentos:
            ...
            if self.tipo != 2:
                ...
                if len(ban) > 0:
                    ...
                    aguarda_presenca_elemento(self.driver, 'toasty', tipo='ID', tempo=0.5)
