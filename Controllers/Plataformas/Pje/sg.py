...
class PjeSg(SegundoGrau, Pje):

    # CAPTURA DADOS DO PROCESSO
    def dados(self, status_atual):
        rec = {}
        xpaths = ('//*[@id="maisDetalhes"]/dl/dt','//*[@id="maisDetalhes"]/div[1]/dl/dt',)
        campos = {'Julgador': 'rec_orgao', 'Assunto': 'rec_assunto', 'Valor': 'rec_valor', 'Segredo': 'rec_segredo',  'Relator': 'rec_relator', 'distribuição': 'rec_distribuicao',}
        for xp in xpaths:
        ...
        rec['rec_status'] = get_status(self.movs, status_atual, 2)
